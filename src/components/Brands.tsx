...
export default function Brands() {
  const brands = [
    ...
    { name: "Samsung", id: "samsung", src: "/samsung.jpg" },
    { name: "Google", id: "google", src: "/google.png" },
    { name: "OnePlus", id: "oneplus", src: "/oneplus.png" },
    { name: "MI", id: "mi", src: "/mi.png" },
    { name: "Vivo", id: "vivo", src: "/vivo.png" },
    { name: "Oppo", id: "oppo", src: "/oppo.png" },
    { name: "Realme", id: "realme", src: "/realme.png" },
    { name: "iQOO", id: "iqoo", src: "/iqoo.png" },
    { name: "Motorola", id: "motorola", src: "/moto.png" }
  ];
        ...
        <div className="flex gap-6 sm:gap-12 flex-wrap items-center">
          {brands.map((brand) => (
            <Link 
              ...
              key={brand.id}
              className="relative group w-32 h-32 md:w-48 md:h-32 border border-gray-100 shadow-sm rounded-xl flex items-center justify-center hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-white overflow-hidden"
            >
              <Image 
                src={brand.src} 
                alt={`${brand.name} logo`} 
